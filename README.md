...
## Research Questions
- Is there a measurable association between daily listening hours and depression scores?
- Are specific genres associated with elevated anxiety or insomnia?
- Does BPM correlate with insomnia?
- Which variable best predicts whether music improves or worsens mood?

---

## Dataset
**Music & Mental Health Survey Results** – available on [Kaggle](https://www.kaggle.com/datasets/catherinerasgaitis/mxmh-survey-results)
...
2. Upload `mxmh_survey_results.csv` using the Files sidebar
...
| `mxmh_survey_results.csv` | Raw dataset (must be uploaded manually to Colab) |
